...
**三窗口架构**：
- `main`（160×200）：透明置顶桌宠本体 + 境界光环 + 坐骑绘制
...
- ✅ **修仙商店**：丹药/坐骑(5种)/法术(5种) + 独立窗口
- ✅ **坐骑系统**：飞剑/葫芦/青龙/麒麟/凤凰（程序绘制，桌宠骑乘）
- ✅ **法术系统**：火球术/冰封术/雷劫术/万剑诀/天地同寿（全屏特效）
